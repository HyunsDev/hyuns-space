  ...
  return (
    ...
    >
      ...
      {href ? (
        ...
        <div className="text-muted-foreground bg-muted px-1 rounded font-mono text-sm">
          {text}
        </div>
      )}
    </motion.div>
...
export function AboutContactSection() {
  return (
    <div className="min-h-[calc(100dvh-150px)] pt-[200px] pb-[250px] px-4 max-w-[400px] w-full m-auto">
      <motion.div
        initial={{ y: 8, opacity: 0 }}
        whileInView={{ y: 0, opacity: 1 }}
        ...
        viewport={{ once: true }}
      >
        <h2 className="font-medium text-xl text-center">Contact & Link</h2>
      </motion.div>
      <div className="mt-10 text-center flex flex-col break-keep gap-2">
        <ContactRow
          label="Email"
          text="hyuns@hyuns.dev"
        ...
        <ContactRow
          label="Instagram"
          text="hyuns_space"
          href="https://instagram.com/hyuns_space"
          delay={1.0}
          icon={
            <svg
              role="img"
        ...
        <div className="text-center text-muted-foreground text-sm mt-8">
          개인적인 이야기를 나누고 싶다면
          <br />
          Instagram이나, Discord를 통해 언제든 연락해주세요. 🙌
        </div>
      </div>
    </div>
  );
